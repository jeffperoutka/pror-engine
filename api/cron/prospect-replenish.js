...
const CLIENT_CONFIGS = [
  {
    ...
    senderWarmed: { id: 3, email: 'yam@ecom-ranker.com', name: 'Josh' },
    senderNew: { id: 28, email: 'yam@ableammo.ecom-ranker.com', name: 'Josh' },
  },
  {
    slug: 'DR-DABBER',
    name: 'Dr. Dabber',
    ...
    senderWarmed: { id: 4, email: 'yam@ecom-guestposts.com', name: 'Josh' },
    senderNew: { id: 29, email: 'yam@drdabber.ecom-guestposts.com', name: 'Josh' },
  },
  {
    slug: 'FELINA',
    name: 'Felina',
    ...
    senderWarmed: { id: 5, email: 'yam@guestpost-now.com', name: 'Josh' },
    senderNew: { id: 30, email: 'yam@felina.guest-poster.com', name: 'Josh' },
  },
  {
    slug: 'MILL-PACKAGING',
    name: 'Mill Packaging',
    ...
    senderWarmed: { id: 6, email: 'yam@linkinsertion.live', name: 'Josh' },
    senderNew: { id: 31, email: 'yam@millpkg.linkinsertion.live', name: 'Josh' },
  },
  {
    slug: 'PRIMERX',
    name: 'PrimeRx',
    ...
    senderWarmed: { id: 7, email: 'yam@guest-poster.com', name: 'Josh' },
    senderNew: { id: 32, email: 'yam@primerx.guestpost-now.com', name: 'Josh' },
  },
  {
    slug: 'SMOKEA',
    name: 'SMOKEA',
    ...
    senderWarmed: { id: 8, email: 'yam@guest-post.live', name: 'Josh' },
    senderNew: { id: 33, email: 'yam@smokea.guest-post.live', name: 'Josh' },
  },
  {
    slug: 'MRSKIN',
    name: 'MrSkin',
    ...
    senderWarmed: { id: 9, email: 'yam@ecom-links.com', name: 'Josh' },
    senderNew: { id: 34, email: 'yam@mrskin.ecom-links.com', name: 'Josh' },
  },
  {
    slug: 'VRAI',
    name: 'VRAI',
    ...
    senderWarmed: { id: 10, email: 'yam@linkinsertion.us', name: 'Josh' },
    senderNew: { id: 35, email: 'yam@vrai.linkinsertion.us', name: 'Josh' },
  },
  {
    ...
    senderWarmed: { id: 11, email: 'yam@kobo.linkinsertion.org', name: 'Josh' },
    senderNew: { id: 36, email: 'yam@amsfulfillment.ecom-ranker.com', name: 'Josh' },
  },
  {
    slug: 'BUILT-BAR',
    name: 'Built Bar',
    ...
    senderWarmed: { id: 12, email: 'yam@opensea.linkinsertion.org', name: 'Josh' },
    senderNew: { id: 37, email: 'yam@builtbar.ecom-guestposts.com', name: 'Josh' },
  },
  {
    slug: 'NUTRABIO',
    name: 'NutraBio',
    ...
    senderWarmed: { id: 2, email: 'yam@linkinsertion.org', name: 'Josh' },
    senderNew: { id: 38, email: 'yam@nutrabio.guest-poster.com', name: 'Josh' },
  },
  {
    slug: 'VIVANTE-LIVING',
    name: 'Vivante Living',
    ...
    senderWarmed: { id: 3, email: 'yam@ecom-ranker.com', name: 'Josh' },
    senderNew: { id: 39, email: 'yam@vivante.linkinsertion.live', name: 'Josh' },
  },
  {
    slug: 'GOODR',
    name: 'Goodr',
    ...
    senderWarmed: { id: 4, email: 'yam@ecom-guestposts.com', name: 'Josh' },
    senderNew: { id: 40, email: 'yam@goodr.guestpost-now.com', name: 'Josh' },
  },
];

// ─── Email Templates — imported from shared/templates.js (single source of truth) ─────
